...
(
	"Ten" => array(								//album with all of the needed info
		"artist" 	=> 	"Pearl Jam",
		"image"		=> 	"PearlJam.jpg",			//sets the image for the album
		"tracks"	=>	array
		(
			0		=> array
			(								//track information
				0 => "1",					//track number
				1 => "Jeremy",				//track name 
				2 => "5:33",				//track track duration
				3 => "Ten/Jeremy.mp3"		//track location
			),
...
<html>
	...
	<body>
		...
		<div id="logo"><a id="logo-text" href="index.html">Retro Radio</a></div>		<!--logo with hyperlink -->
				<nav id="main-nav">
					<ul>
						...
						<li><a href="Beatles.php">Playlist</a></li>			<!--link to the playlist -->
					</ul>
				</nav>
		</header>
		...
		<div id="multimeida-container">
            ...
            <div id="Ten">
					<table class="table-fill">
						...
						<?php 
						for ($al=0; $al < count($album["Ten"]["tracks"]); $al++) { 		//loops through all of the songs
						echo "<tr>"; 
						for ($iets=0; $iets < 3; $iets++){
							echo "<td>";
							echo $album["Ten"]["tracks"][$al][$iets]; 			//echos the tracks and the info
							echo "</td>";
						}
						?>
							<td>
								<audio controls src="songs/<?php echo $album["Ten"]["tracks"][$al][$iets]; ?>"></audio>		<!-- echos all of the songs-->
							</td>
        ...
        <iframe
            ...
            src="https://www.youtube.com/embed/3g1Tu2Ulrk0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
        <br/>
    </div>
    </body>
